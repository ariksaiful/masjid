              ...
              <div class="card-body px-4 py-4">
                ...
                <?= form_open('masuk/auth', 'id="formMasuk"');?>
                  ...
                  <div class="text-center">
                    ...
                    <!-- <div class="row mt-2">
                      <div class="col-md-12">
                        <a href="" class="btn btn-outline-warning btn-block btn-md pt-2 pb-2 mt-2"><i class="fas fa-calculator"></i>Kalkulator Zakat</a>
                      </div>
                    </div> -->
                  </div>
                  <div class="text-center mt-3">
                    <small class="text-white-50">Copyright &copy; 2024 - SISTEM INFORMASI MANAJEMEN MASJID<br/>by Zakaria Saiful Akbar</small>
                  </div>
                </form>
              </div>
            </div>
